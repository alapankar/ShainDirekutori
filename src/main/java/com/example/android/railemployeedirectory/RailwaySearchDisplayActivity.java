...
public class RailwaySearchDisplayActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.railway_search_display);
                        ...
                        public void run() {
                            ...
                            try {
                                try {
                                    ...
                                    chkbx.setText(jsonObject.getString("Railway_Office"));
                                    ...
                                    if (jsonObject1.has("Railway_Office")) {
                                        checkBox = new CheckBox(RailwaySearchDisplayActivity.this);
                                        linearLayout.addView(checkBox);
                                        checkBox.setText(jsonObject1.getString("Railway_Office"));
                                        ...
                                        checkBox.setOnClickListener(new View.OnClickListener() {
                                            ...
                                            public void onClick(View v) {
                                                det.setOnClickListener(new View.OnClickListener() {
                                                    public void onClick(View v) {
                                                        Intent intent = new Intent(RailwaySearchDisplayActivity.this, DetailsActivity.class);
                                    ...
                                    if (jsonObject2.has("Railway_Office")) {
                                        checkBox = new CheckBox(RailwaySearchDisplayActivity.this);
                                        linearLayout.addView(checkBox);
                                        checkBox.setText(jsonObject2.getString("Railway_Office"));
